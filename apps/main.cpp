...
int main() {
    ...
    vtkWriter sol1("sol1", "sol1", mesh1);
    vtkWriter sol2("sol2", "sol2", mesh2);

    sol1.add_scalars(solve1.get_solve(), "U");
    sol1.write();

    sol2.add_scalars(solve2.get_solve(), "U");
    sol2.write();
